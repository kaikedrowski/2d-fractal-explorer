...
public:
    ...
    void setDVec2(const std::string &name, float x, float y) const
    { 
    ...
    void setDVec3(const std::string &name, float x, float y, float z) const
    { 
    ...
    void setDVec4(const std::string &name, float x, float y, float z, float w) const
    { 
